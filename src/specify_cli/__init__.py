...
AGENT_CONFIG = {
    ...
    "kiro-cli": {
        ...
        "folder": ".kiro/",
        "commands_subdir": "commands",
        "install_url": "https://kiro.com/cli",
        "requires_cli": True,
    },
    "generic": {
...
def init(
    ...
    ai_assistant: str = typer.Option(None, "--ai", help="AI assistant to use: claude, gemini, copilot, cursor-agent, qwen, opencode, codex, windsurf, kilocode, auggie, codebuddy, amp, shai, q, agy, bob, qodercli, kiro-cli, or generic (requires --ai-commands-dir)"),
